...
class AppLocalizations {
  ...
  static const _zhTW = {
    ...
    'cloudTripLimit': '雲端旅行',
    'cloudTripLimitDetail': '免費用戶可同步 3 個旅行至雲端，付費用戶最多 20 個。本地旅行不受此限制。',
  ...
  static const _en = {
    ...
    'cloudTripLimitDetail': 'Free users can sync up to 3 trips. Premium users can sync up to 20. Local trips are unlimited.',
  ...
  static const _ja = {
    ...
    'cloudTripLimitDetail': '無料ユーザーは最大3件、プレミアムユーザーは最大20件の旅行をクラウドに同期できます。ローカル旅行は制限なしです。',
  ...
  static const _ko = {
    ...
    'cloudTripLimitDetail': '무료 사용자는 최대 3개, 프리미엄 사용자는 최대 20개의 여행을 클라우드에 동기화할 수 있습니다. 로컬 여행은 제한 없습니다.',
  ...
  static const _zhCN = {
    ...
    'cloudTripLimit': '云端旅行',
    'cloudTripLimitDetail': '免费用户可同步 3 个旅行至云端，付费用户最多 20 个。本地旅行不受此限制。',
